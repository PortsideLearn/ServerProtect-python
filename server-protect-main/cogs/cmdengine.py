...
[Сайт бота](https://youtu.be/dQw4w9WgXcQ)
        ...
        embed.add_field(
            ...
            inline=False,
            value=f'''
<:cymon:1009399173235363880> **Cymon#4380** - за оригинальный код бота и аватарку боту. Жалко краш протекта :'(
<:artembay:1009399252583198720> **Artem Bay#0547** - за экстренную помощь по хостингу
            '''
        )
