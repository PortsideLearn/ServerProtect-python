...
'Весьма сомнительно :x:']
    ...
    async def inv(self, ctx):
        if ctx.author.id in [356737308898099201, 879405136135475242, 1012347822760271912]:
    ...
    async def addbl(self, ctx, id: int, *, reason="Причина не указана."):
        if ctx.author.id not in [356737308898099201, 879405136135475242, 1012347822760271912]:
